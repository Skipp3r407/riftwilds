...
- **Source:** [Dark Sci-Fi Audio Pack](https://opengameart.org/content/dark-sci-fi-audio-pack) on OpenGameArt
- **Author:** SRG774
- **License:** [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) (public domain dedication)
- **Files:** `sector.mp3`, `airy.mp3`, `pulse.mp3`, `urgent.mp3`, `transmission.mp3`
- **Notes:** Gentle, loopable sci-fi ambient beds. Attribution not required; appreciated by the author.

## Magic Space

- **Source:** [Magic Space](https://opengameart.org/content/magic-space) on OpenGameArt
- **Author:** CodeManu
- **License:** [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) / public domain (stated on source page)
...
- **Source:** [Menacing Otherworld](https://opengameart.org/content/menacing-otherworld) on OpenGameArt
- **Author:** Ruskerdax
- **License:** [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/)
- **File:** `menacing-otherworld.mp3`
- **Notes:** Ambient industrial exploration / hostile-dimension mood.

## Dark Things

- **Source:** [Dark Things Loop](https://opengameart.org/content/dark-things-loop) on OpenGameArt
- **Author:** iamoneabe
...
- **Source:** [Sirens in Darkness](https://opengameart.org/content/sirens-in-darkness) on OpenGameArt
- **Author:** The Cynic Project (cynicmusic) / [pixelsphere.org](http://pixelsphere.org/) / [cynicmusic.com](https://cynicmusic.com)
- **License:** [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/)
- **File:** `sirens-in-darkness.mp3`
- **Notes:** Ethereal ambient pads and piano. Attribution appreciated (not required under CC0).
