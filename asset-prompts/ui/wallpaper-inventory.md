...
## Scene
Full-bleed atmospheric wallpaper for the **inventory** route. Soft affinity glows (#3d9bff, #d0d6e0, #3de7ff), faint plus-grid, distant rift ridges. No UI chrome, no text, no logos.
