...
Create a completely original 2D fantasy potion named Cleaning Kit.

Potion type: CARE
Affinity: neutral
Rarity: COMMON
Bottle shape: unique cork/stopper/charm design for Cleaning Kit
Liquid color: affinity-inspired
Magical effect: Improves hygiene.
