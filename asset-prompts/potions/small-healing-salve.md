...
Create a completely original 2D fantasy potion named Small Healing Salve.

Potion type: HEALTH
Affinity: GROVE
Rarity: COMMON
Bottle shape: unique cork/stopper/charm design for Small Healing Salve
Liquid color: affinity-inspired
Magical effect: Restores a small percentage of battle health.
