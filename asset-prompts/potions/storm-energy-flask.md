...
Create a completely original 2D fantasy potion named Storm Energy Flask.

Potion type: ENERGY
Affinity: STORM
Rarity: RARE
Bottle shape: unique cork/stopper/charm design for Storm Energy Flask
Liquid color: affinity-inspired
Magical effect: Restores large energy; short cooldown.
