...
Create a completely original 2D fantasy potion named Rift Salve Kit.

Potion type: RECOVERY
Affinity: SPIRIT
Rarity: RARE
Bottle shape: unique cork/stopper/charm design for Rift Salve Kit
Liquid color: affinity-inspired
Magical effect: Restores care health substantially.
