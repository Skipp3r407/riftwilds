...
Create a completely original 2D fantasy potion named Dormancy Revival Bloom.

Potion type: RECOVERY
Affinity: GROVE
Rarity: RARE
Bottle shape: unique cork/stopper/charm design for Dormancy Revival Bloom
Liquid color: affinity-inspired
Magical effect: Assists recovery from dormancy when permanent death is disabled.
