...
Create a completely original 2D fantasy potion named Rootbreak Tonic.

Potion type: STATUS
Affinity: GROVE
Rarity: UNCOMMON
Bottle shape: unique cork/stopper/charm design for Rootbreak Tonic
Liquid color: affinity-inspired
Magical effect: Removes ROOTED; minor secondary soothe.
