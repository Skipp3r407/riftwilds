...
Create a completely original 2D fantasy potion named Glowmoss Chew.

Potion type: CARE
Affinity: GROVE
Rarity: COMMON
Bottle shape: unique cork/stopper/charm design for Glowmoss Chew
Liquid color: affinity-inspired
Magical effect: Improves happiness and lightly eases stress.
