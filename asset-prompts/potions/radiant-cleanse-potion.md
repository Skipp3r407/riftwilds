# Radiant Cleanse Potion

| Field | Value |
|-------|-------|
| Name | Radiant Cleanse Potion |
| Type | STATUS |
| Rarity | UNCOMMON |
| Affinity | RADIANT |
...
Create a completely original 2D fantasy potion named Radiant Cleanse Potion.

Potion type: STATUS
Affinity: RADIANT
Rarity: UNCOMMON
Bottle shape: unique cork/stopper/charm design for Radiant Cleanse Potion
Liquid color: affinity-inspired
Magical effect: Removes SILENCED; minor secondary soothe.
