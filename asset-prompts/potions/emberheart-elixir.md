...
Create a completely original 2D fantasy potion named Emberheart Elixir.

Potion type: HEALTH
Affinity: EMBER
Rarity: RARE
Bottle shape: unique cork/stopper/charm design for Emberheart Elixir
Liquid color: affinity-inspired
Magical effect: Restores health and temporarily improves attack.
