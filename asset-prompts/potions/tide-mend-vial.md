...
Create a completely original 2D fantasy potion named Tide Mend Vial.

Potion type: HEALTH
Affinity: TIDE
Rarity: COMMON
Bottle shape: unique cork/stopper/charm design for Tide Mend Vial
Liquid color: affinity-inspired
Magical effect: Restores a small amount of battle health.
