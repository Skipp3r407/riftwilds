...
Create a completely original 2D fantasy potion named Frost Thaw Brew.

Potion type: STATUS
Affinity: FROST
Rarity: UNCOMMON
Bottle shape: unique cork/stopper/charm design for Frost Thaw Brew
Liquid color: affinity-inspired
Magical effect: Removes CHILLED; minor secondary soothe.
