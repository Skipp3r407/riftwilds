...
Create a completely original 2D fantasy potion named Focus Tonic.

Potion type: ENERGY
Affinity: SPIRIT
Rarity: UNCOMMON
Bottle shape: unique cork/stopper/charm design for Focus Tonic
Liquid color: affinity-inspired
Magical effect: Restores moderate energy.
