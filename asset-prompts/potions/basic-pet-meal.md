...
Create a completely original 2D fantasy potion named Basic Pet Meal.

Potion type: CARE
Affinity: neutral
Rarity: COMMON
Bottle shape: unique cork/stopper/charm design for Basic Pet Meal
Liquid color: affinity-inspired
Magical effect: Restores hunger. Gameplay-earned meals also available.
