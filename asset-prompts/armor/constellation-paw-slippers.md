# Constellation Paw Slippers

| Field | Value |
|-------|-------|
| Name | Constellation Paw Slippers |
| Category | Armor / COSMETIC_SET |
| Rarity | MYTHIC |
| Affinity | RADIANT |
...
Name: Constellation Paw Slippers
Armor category: COSMETIC_SET
Affinity: RADIANT
Rarity: MYTHIC
Compatible body type: frontPaw, rearPaw

Prestige paw slippers that leave star-print trails.
