...
Create a completely original square 2D fantasy ability icon for Ancient Mountain Guard.

Affinity: STONE
Ability category: ULTIMATE
Visual action: Signature Stone ultimate (defensive).
