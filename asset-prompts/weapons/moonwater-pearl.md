...
| File names | `moonwater-pearl.png`, `moonwater-pearl-icon.png`, `moonwater-pearl-overlay-l.png`, `moonwater-pearl-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Moonwater Pearl.
...
The weapon has a distinctive silhouette matching Luminous pearl focus cradled in a water halo., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Moonwater Pearl on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Moonwater Pearl: stylized non-graphic impact sparks matching TIDE affinity.
