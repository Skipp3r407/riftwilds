...
| Attachment | horn |
| File names | `simple-horncap.png`, `simple-horncap-icon.png`, `simple-horncap-overlay-l.png`, `simple-horncap-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Simple Horncap.
...
The weapon has a distinctive silhouette matching Plain mineral caps for horned practice charges., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Simple Horncap on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Simple Horncap: stylized non-graphic impact sparks matching STONE affinity.
