# Alloy Training Blade

| Field | Value |
|-------|-------|
| Name | Alloy Training Blade |
| Category | Weapon / TAIL |
| Rarity | UNCOMMON |
| Affinity | ALLOY |
| Purpose | Inventory + battle overlay |
| Canvas | 1024×1024 inventory · 256 icon · 512 overlay |
| Attachment | tailTip |
| File names | `alloy-training-blade.png`, `alloy-training-blade-icon.png`, `alloy-training-blade-overlay-l.png`, `alloy-training-blade-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Alloy Training Blade.

Weapon class: TAIL
Affinity: ALLOY
Rarity: UNCOMMON
Compatible anatomy: tailTip, harness

The weapon has a distinctive silhouette matching Segmented practice blade for alloy species., constructed from original fantasy materials with controlled magical energy.

It attaches using tailTip.
...
Cropped iconic Alloy Training Blade on transparent background, strong silhouette, readable at 48px.

## Overlay prompt

Battle overlay for tailTip, left and right facing, transparent, no clipping through pet face.

## Effect prompt

Attack VFX for Alloy Training Blade: stylized non-graphic impact sparks matching ALLOY affinity.
