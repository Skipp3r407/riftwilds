...
| File names | `tideglass-claws.png`, `tideglass-claws-icon.png`, `tideglass-claws-overlay-l.png`, `tideglass-claws-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Tideglass Claws.

Weapon class: CLAW
Affinity: TIDE
Rarity: UNCOMMON
Compatible anatomy: frontPaw, biped

The weapon has a distinctive silhouette matching Translucent claw sheaths with flowing runes., constructed from original fantasy materials with controlled magical energy.

It attaches using frontPawLeft.
...
Cropped iconic Tideglass Claws on transparent background, strong silhouette, readable at 48px.

## Overlay prompt

Battle overlay for frontPawLeft, left and right facing, transparent, no clipping through pet face.

## Effect prompt

Attack VFX for Tideglass Claws: stylized non-graphic impact sparks matching TIDE affinity.
