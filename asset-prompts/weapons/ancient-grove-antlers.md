...
| Attachment | horn |
| File names | `ancient-grove-antlers.png`, `ancient-grove-antlers-icon.png`, `ancient-grove-antlers-overlay-l.png`, `ancient-grove-antlers-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Ancient Grove Antlers.
...
The weapon has a distinctive silhouette matching Living antler guard humming with old roots., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Ancient Grove Antlers on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Ancient Grove Antlers: stylized non-graphic impact sparks matching GROVE affinity.
