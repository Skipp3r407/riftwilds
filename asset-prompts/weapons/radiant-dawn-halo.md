...
| File names | `radiant-dawn-halo.png`, `radiant-dawn-halo-icon.png`, `radiant-dawn-halo-overlay-l.png`, `radiant-dawn-halo-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Radiant Dawn Halo.
...
The weapon has a distinctive silhouette matching Broken-ring dawn halo of light shards., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Radiant Dawn Halo on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Radiant Dawn Halo: stylized non-graphic impact sparks matching RADIANT affinity.
