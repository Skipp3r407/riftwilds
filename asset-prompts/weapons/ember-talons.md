...
| File names | `ember-talons.png`, `ember-talons-icon.png`, `ember-talons-overlay-l.png`, `ember-talons-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Ember Talons.

Weapon class: CLAW
Affinity: EMBER
Rarity: UNCOMMON
Compatible anatomy: frontPaw, quadruped, biped

The weapon has a distinctive silhouette matching Coal-black claw caps that spark on impact., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Ember Talons on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Ember Talons: stylized non-graphic impact sparks matching EMBER affinity.
