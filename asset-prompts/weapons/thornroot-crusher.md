...
| Attachment | horn |
| File names | `thornroot-crusher.png`, `thornroot-crusher-icon.png`, `thornroot-crusher-overlay-l.png`, `thornroot-crusher-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Thornroot Crusher.

Weapon class: HORN
Affinity: GROVE
Rarity: RARE
Compatible anatomy: horn, head

The weapon has a distinctive silhouette matching Rooted crest that channels thorny force., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Thornroot Crusher on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Thornroot Crusher: stylized non-graphic impact sparks matching GROVE affinity.
