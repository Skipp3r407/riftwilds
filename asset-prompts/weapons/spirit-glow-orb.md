...
| File names | `spirit-glow-orb.png`, `spirit-glow-orb-icon.png`, `spirit-glow-orb-overlay-l.png`, `spirit-glow-orb-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Spirit Glow Orb.
...
The weapon has a distinctive silhouette matching Warm lantern-light focus for spirit pets., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Spirit Glow Orb on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Spirit Glow Orb: stylized non-graphic impact sparks matching SPIRIT affinity.
