...
| File names | `heart-of-the-volcano.png`, `heart-of-the-volcano-icon.png`, `heart-of-the-volcano-overlay-l.png`, `heart-of-the-volcano-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Heart of the Volcano.
...
The weapon has a distinctive silhouette matching A hovering magma core that pulses like a living forge., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Heart of the Volcano on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Heart of the Volcano: stylized non-graphic impact sparks matching EMBER affinity.
