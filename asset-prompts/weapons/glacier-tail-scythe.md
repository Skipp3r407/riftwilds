...
| Attachment | tailTip |
| File names | `glacier-tail-scythe.png`, `glacier-tail-scythe-icon.png`, `glacier-tail-scythe-overlay-l.png`, `glacier-tail-scythe-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Glacier Tail Scythe.
...
The weapon has a distinctive silhouette matching Curved glacial blade for sweeping frost arcs., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Glacier Tail Scythe on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Glacier Tail Scythe: stylized non-graphic impact sparks matching FROST affinity.
