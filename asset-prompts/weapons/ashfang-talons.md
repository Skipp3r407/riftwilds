...
| File names | `ashfang-talons.png`, `ashfang-talons-icon.png`, `ashfang-talons-overlay-l.png`, `ashfang-talons-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Ashfang Talons.

Weapon class: CLAW
Affinity: EMBER
Rarity: RARE
Compatible anatomy: frontPaw

The weapon has a distinctive silhouette matching Ash-tempered fang claws with ember vents., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Ashfang Talons on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Ashfang Talons: stylized non-graphic impact sparks matching EMBER affinity.
