...
| File names | `basic-focus-orb.png`, `basic-focus-orb-icon.png`, `basic-focus-orb-overlay-l.png`, `basic-focus-orb-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Basic Focus Orb.

Weapon class: FLOATING_FOCUS
Affinity: SPIRIT
Rarity: COMMON
Compatible anatomy: floatingFocus, spirit

The weapon has a distinctive silhouette matching A dim hovering orb for first magic drills., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Basic Focus Orb on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Basic Focus Orb: stylized non-graphic impact sparks matching SPIRIT affinity.
