...
| File names | `radiant-sun-disk.png`, `radiant-sun-disk-icon.png`, `radiant-sun-disk-overlay-l.png`, `radiant-sun-disk-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Radiant Sun Disk.
...
The weapon has a distinctive silhouette matching Hovering sun-disk that flares on command., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Radiant Sun Disk on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Radiant Sun Disk: stylized non-graphic impact sparks matching RADIANT affinity.
