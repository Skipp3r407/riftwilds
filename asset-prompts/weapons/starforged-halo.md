...
| File names | `starforged-halo.png`, `starforged-halo-icon.png`, `starforged-halo-overlay-l.png`, `starforged-halo-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Starforged Halo.
...
The weapon has a distinctive silhouette matching Cosmic halo — prestige first, combat capped., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Starforged Halo on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Starforged Halo: stylized non-graphic impact sparks matching RADIANT affinity.
