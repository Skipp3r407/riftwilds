...
| Attachment | tailTip |
| File names | `celestial-riftblade.png`, `celestial-riftblade-icon.png`, `celestial-riftblade-overlay-l.png`, `celestial-riftblade-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Celestial Riftblade.

Weapon class: TAIL
Affinity: neutral
Rarity: CELESTIAL
Compatible anatomy: tailTip

The weapon has a distinctive silhouette matching Star-edged blade that opens soft rift trails., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Celestial Riftblade on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Celestial Riftblade: stylized non-graphic impact sparks matching neutral affinity.
