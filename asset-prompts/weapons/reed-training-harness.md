...
| Attachment | back |
| File names | `reed-training-harness.png`, `reed-training-harness-icon.png`, `reed-training-harness-overlay-l.png`, `reed-training-harness-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Reed Training Harness.

Weapon class: HARNESS
Affinity: GROVE
Rarity: COMMON
Compatible anatomy: back, chest

The weapon has a distinctive silhouette matching Light reed straps for practice marches., constructed from original fantasy materials with controlled magical energy.
...
Cropped iconic Reed Training Harness on transparent background, strong silhouette, readable at 48px.
...
Attack VFX for Reed Training Harness: stylized non-graphic impact sparks matching GROVE affinity.
