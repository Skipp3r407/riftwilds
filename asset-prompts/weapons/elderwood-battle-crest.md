# Elderwood Battle Crest

| Field | Value |
|-------|-------|
| Name | Elderwood Battle Crest |
| Category | Weapon / HORN |
| Rarity | LEGENDARY |
| Affinity | GROVE |
| Purpose | Inventory + battle overlay |
| Canvas | 1024×1024 inventory · 256 icon · 512 overlay |
| Attachment | horn |
| File names | `elderwood-battle-crest.png`, `elderwood-battle-crest-icon.png`, `elderwood-battle-crest-overlay-l.png`, `elderwood-battle-crest-overlay-r.png` |

## Full art prompt

Create a completely original 2D fantasy pet weapon named Elderwood Battle Crest.

Weapon class: HORN
Affinity: GROVE
Rarity: LEGENDARY
Compatible anatomy: horn

The weapon has a distinctive silhouette matching Ancient wood crest etched with root-runes., constructed from original fantasy materials with controlled magical energy.

It attaches using horn.
...
Cropped iconic Elderwood Battle Crest on transparent background, strong silhouette, readable at 48px.

## Overlay prompt

Battle overlay for horn, left and right facing, transparent, no clipping through pet face.

## Effect prompt

Attack VFX for Elderwood Battle Crest: stylized non-graphic impact sparks matching GROVE affinity.
