...
const species = [
  ...
  // Wave-2 expansion
  ["slagpup", "EMBER", "Brave", "Molten-pawed pup that cools into tough slag"],
  ["pyrespore", "EMBER", "Curious", "Spore bloom that sheds warm ember pollen"],
  ["cinderquill", "EMBER", "Independent", "Ash-plumed quillbird of crater rim thermals"],
  ["lavaling", "EMBER", "Playful", "Soft lava blob that hardens when startled"],
  ["furnacebeetle", "EMBER", "Protective", "Heat-chambered beetle that vents forge-warm air"],
  ["brinepaw", "TIDE", "Social", "Salt-whiskered coastal prowler with wet prints"],
  ["kelpwisp", "TIDE", "Gentle", "Hovering kelp ribbon that tastes of moonfoam"],
  ["sprayfin", "TIDE", "Energetic", "Surf-skimming finner that leaps through spray"],
  ["pearlurk", "TIDE", "Shy", "Shell-lurking pearl guardian of tide caves"],
  ["tidequill", "TIDE", "Curious", "Shorebird with ink-dark tide-patterned plumage"],
  ["fernfox", "GROVE", "Mischievous", "Fern-tailed fox that vanishes into understory"],
  ["saplingo", "GROVE", "Gentle", "Upright sapling companion with sticky leaf hands"],
  ["vinepup", "GROVE", "Playful", "Vine-wrapped pup that braids trails as it runs"],
  ["thornling", "GROVE", "Protective", "Spined seedling that softens for trusted keepers"],
  ["mossdrake", "GROVE", "Calm", "Low serpentine draped in living moss armor"],
  ["galekit", "STORM", "Energetic", "Wind-ruffed kit that chases cloud shadows"],
  ["cloudleaper", "STORM", "Brave", "Spring-legged peak hopper that rides updrafts"],
  ["sparkmoth", "STORM", "Curious", "Tiny moth whose dust crackles like dry lightning"],
  ["windrift", "STORM", "Independent", "Ribbon-bodied floater that steers on gusts alone"],
  ["thunderpaw", "STORM", "Brave", "Heavy-pawed ridge runner with booming steps"],
  ["shalehorn", "STONE", "Protective", "Layered shale horns scrape sparks from canyon walls"],
  ["gritling", "STONE", "Sleepy", "Grit-bodied pebblekin that naps in dust bowls"],
  ["basaltpup", "STONE", "Calm", "Columnar basalt pup with cool volcanic plates"],
  ["crystowl", "STONE", "Independent", "Crystal-eyed canyon owl that roosts on geodes"],
  ["rubblefin", "STONE", "Curious", "Stone-stream swimmer with gravel-scaled fins"],
  ["glazehare", "FROST", "Shy", "Ice-glazed hare that leaves glass-thin trails"],
  ["rimewing", "FROST", "Calm", "Frost-rimmed wing that sings in thin cold air"],
  ["iciclepup", "FROST", "Playful", "Icicle-whiskered pup that chews soft snow"],
  ["snowglyph", "FROST", "Curious", "Snow-script spirit that writes fading runes"],
  ["frostbloom", "FROST", "Gentle", "Ice-petaled bloom that opens only at blue dusk"],
  ["dawnkit", "RADIANT", "Social", "Sunrise-furred kit that warms cold stone floors"],
  ["prismoth", "RADIANT", "Playful", "Facet-wing moth that scatters soft prism dust"],
  ["solfinch", "RADIANT", "Energetic", "Sunbeam finch nesting in citadel lattice light"],
  ["gleamhare", "RADIANT", "Mischievous", "Gleaming hare that blinks bright when startled"],
  ["lightspire", "RADIANT", "Calm", "Spire of condensed dawnlight with a gentle pulse"],
  ["umbralisk", "VOID", "Independent", "Shadow-coil serpent that drinks dim corridor light"],
  ["duskling", "VOID", "Shy", "Dusk orb that dims lanterns when nervous"],
  ["nullpaw", "VOID", "Curious", "Soft-pawed voidling that erases its own footprints"],
  ["echofig", "VOID", "Sleepy", "Fig-shaped hollow plant that whispers back sounds"],
  ["shadowmire", "VOID", "Protective", "Living mire of night that shelters lost pets"],
  ["boltgear", "ALLOY", "Energetic", "Bolt-hearted gearling that spins when excited"],
  ["scrapowl", "ALLOY", "Curious", "Copper-feather owl nesting in scrap rafters"],
  ["copperfin", "ALLOY", "Calm", "Cooling-channel swimmer with copper scale plates"],
  ["wirefox", "ALLOY", "Mischievous", "Wire-tailed fox that rewires shiny refuse into toys"],
  ["chronobeetle", "ALLOY", "Protective", "Clock-shelled beetle that ticks in sync with ruins"],
  ["ghostbloom", "SPIRIT", "Gentle", "Pale marsh bloom that glows when keepers sing"],
  ["dreamhare", "SPIRIT", "Sleepy", "Soft hare that naps across thin dream borders"],
  ["wispdeer", "SPIRIT", "Shy", "Antlered wisp-deer leaving lantern-light prints"],
  ["soulmoth", "SPIRIT", "Curious", "Soul-dust moth that follows honest promises"],
  ["starveil", "SPIRIT", "Calm", "Veil of starlit silk from the Celestial Rift edge"],
];
