...
async function main() {
  ...
  runMask([
    ...
    path.join(OUT_PROPS, "tree-oak.png"),
    path.join(OUT_PROPS, "tree-pine.png"),
    path.join(OUT_PROPS, "tree-birch.png"),
    path.join(OUT_PROPS, "tree-flowering.png"),
    path.join(OUT_PROPS, "tree-rift.png"),
    path.join(OUT_PROPS, "tree-orchard.png"),
