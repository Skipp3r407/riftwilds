"""Remask generated brand logos (theme2) → true RGBA, install into public/assets/brand."""
...
jobs = [
    ("riftwilds-mark-theme2.png", "riftwilds-mark.png", 512, 512, True),
    ("riftwilds-wordmark-theme2.png", "riftwilds-wordmark.png", None, 140, False),
    ("riftwilds-logo-theme2.png", "riftwilds-logo.png", None, 180, False),
]
