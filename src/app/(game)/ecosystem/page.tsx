          ...
          <section className="panel p-5">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-3 text-sm">
              {[
                ...
                { href: "/housing", label: "Player Housing", slug: "housing-catalog" },
                { href: "/neighborhoods", label: "Neighborhoods", slug: "housing-catalog" },
                { href: "/api/housing/catalog", label: "Housing catalog", slug: "housing-catalog" },
                { href: "/api/neighborhoods", label: "Neighborhoods API", slug: "housing-catalog" },
