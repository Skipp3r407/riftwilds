...
export function getDemoMarketplaceListings(): MarketplaceListingView[] {
  return [
    ...
    }),
    {
      ...
      priceLamports: solToLamports("0.025").toString(),
      priceSol: "0.025",
      priceCredits: 250,
      currency: "CREDITS",
      status: "ACTIVE",
    ...
    },
    {
      ...
      priceLamports: solToLamports("0.04").toString(),
      priceSol: "0.04",
      priceCredits: 400,
      currency: "CREDITS",
      status: "ACTIVE",
      createdAt: new Date(Date.now() - 3200_000).toISOString(),
      expiresAt: new Date(Date.now() + LISTING_RULES.maxListingDurationDays * 86400_000).toISOString(),
      bundleMode: null,
      bundledItems: [],
      egg: null,
    ...
    },
    {
      ...
      priceLamports: solToLamports("0.02").toString(),
      priceSol: "0.02",
      priceCredits: 200,
      currency: "CREDITS",
      status: "ACTIVE",
    ...
    },
    {
      ...
      priceLamports: solToLamports("0.05").toString(),
      priceSol: "0.05",
      priceCredits: 500,
      currency: "CREDITS",
      status: "ACTIVE",
      createdAt: new Date(Date.now() - 1500_000).toISOString(),
      expiresAt: new Date(Date.now() + LISTING_RULES.maxListingDurationDays * 86400_000).toISOString(),
      bundleMode: null,
      bundledItems: [],
      egg: null,
