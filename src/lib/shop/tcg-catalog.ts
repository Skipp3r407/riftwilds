...
export function getTcgFeaturedOffers(): ShopCardData[] {
  return [
    card({
      ...
      family: "TCG_PACK",
      affinity: "EMBER",
      iconPath: "/assets/ui/shop/pack-ember.png",
      priceSol: "0.02",
    ...
    card({
      ...
      family: "TCG_PACK",
      affinity: "TIDE",
      iconPath: "/assets/ui/shop/pack-tide.png",
      priceSol: "0.02",
      effect: "Adds 3 binder cards · Credits checkout",
    }),
    card({
      ...
      family: "TCG_BINDER",
      affinity: null,
      iconPath: "/assets/ui/shop/binder-page.png",
      priceSol: "0.015",
    ...
    card({
      ...
      family: "TCG_DECK",
      affinity: null,
      iconPath: "/assets/ui/shop/deck-slot.png",
      priceSol: "0.04",
      effect: "+1 saved deck",
    }),
  ];
...
export function getTcgPackOffers(): ShopCardData[] {
  return [
    ...
    card({
      ...
      family: "TCG_PACK",
      affinity: "GROVE",
      iconPath: "/assets/ui/shop/pack-grove.png",
      priceSol: "0.018",
    ...
    card({
      ...
      family: "TCG_PACK",
      affinity: "STORM",
      iconPath: "/assets/ui/shop/pack-storm.png",
      priceSol: "0.035",
      effect: "Adds 3 binder cards",
    }),
  ];
...
export function getTcgCosmeticOffers(): ShopCardData[] {
  return [
    card({
      ...
      family: "TCG_COSMETIC",
      affinity: null,
      iconPath: "/assets/ui/shop/sleeve-cyan.png",
      priceSol: "0.05",
    ...
    card({
      ...
      family: "TCG_COSMETIC",
      affinity: null,
      iconPath: "/assets/ui/shop/sleeve-amber.png",
      priceSol: "0.08",
      effect: "Cosmetic card back",
    }),
    card({
      ...
      family: "TCG_COSMETIC",
      affinity: "EMBER",
      iconPath: "/assets/ui/shop/board-ember.png",
      priceSol: "0.12",
...
export function getTcgBinderOffers(): ShopCardData[] {
  return [
    ...
    card({
      ...
      family: "TCG_BINDER",
      affinity: null,
      iconPath: "/assets/ui/shop/binder-folio.png",
      priceSol: "0.1",
